...
const data = {
  subTitle: 'Mobilidade',
  title: 'Todos os sites e sistemas construídos são 100% acessíveis em smartphones',
  features: [
    {
      id: 1,
      imgSrc: Briefcase,
      altText: 'Acesse de qualquer lugar',
      title: 'Acesse de qualquer lugar',
      text:
        'Você poderá acessar através do seu dispositivo mobile o sistema ou site da sua empresa.',
    },
    {
      id: 2,
      imgSrc: Secure,
      ...
      title: 'Segurança',
      text:
        'Nós importamos sim com a segurança do seu sistema ou site. Utilizamos 100% os servidores de nuvem para hospedar o seu sistema ou site com funcionalidades internas de segurança.',
    },
  ],
};
